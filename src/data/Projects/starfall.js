export const projectProjectStarfall = {
    ...
    description: "Project-Starfall is a 2.5D Metroidvania couch co-op game created by a group of students, it's a game with forces and physics as its core mechanic.",    headerImage: '/images/Logo.jpg',
    images: ['/images/Logo.jpg'], // Using existing image for testing
    tags: ['Game', 'unity', '3D'],
